...
Templates.Boilerplate.header = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml('<a class="close" data-onclick="close">&#00D7;</a>' + soy.$$escapeHtml(opt_data.headerContent));
};
if (goog.DEBUG) {
 ...
 * @suppress {checkTypes}
 */
Templates.Boilerplate.__deltemplate_s30_ad141ca5 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Boilerplate.__deltemplate_s30_ad141ca5.soyTemplateName = 'Templates.Boilerplate.__deltemplate_s30_ad141ca5';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Boilerplate.body'), 'element', 0, Templates.Boilerplate.__deltemplate_s30_ad141ca5);
 ...
 * @suppress {checkTypes}
 */
Templates.Boilerplate.__deltemplate_s36_6643f8c6 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Boilerplate.__deltemplate_s36_6643f8c6.soyTemplateName = 'Templates.Boilerplate.__deltemplate_s36_6643f8c6';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Boilerplate.body'), '', 0, Templates.Boilerplate.__deltemplate_s36_6643f8c6);
 ...
 * @suppress {checkTypes}
 */
Templates.Boilerplate.__deltemplate_s45_99da60a0 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Boilerplate.__deltemplate_s45_99da60a0.soyTemplateName = 'Templates.Boilerplate.__deltemplate_s45_99da60a0';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Boilerplate.footer'), 'element', 0, Templates.Boilerplate.__deltemplate_s45_99da60a0);
 ...
 * @suppress {checkTypes}
 */
Templates.Boilerplate.__deltemplate_s51_391970bc = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Boilerplate.__deltemplate_s51_391970bc.soyTemplateName = 'Templates.Boilerplate.__deltemplate_s51_391970bc';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Boilerplate.footer'), '', 0, Templates.Boilerplate.__deltemplate_s51_391970bc);
 ...
 * @suppress {checkTypes}
 */
Templates.Boilerplate.__deltemplate_s60_a2522d20 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Boilerplate.__deltemplate_s60_a2522d20.soyTemplateName = 'Templates.Boilerplate.__deltemplate_s60_a2522d20';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Boilerplate.header'), 'element', 0, Templates.Boilerplate.__deltemplate_s60_a2522d20);
 ...
 * @suppress {checkTypes}
 */
Templates.Boilerplate.__deltemplate_s66_90bffbc9 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Boilerplate.__deltemplate_s66_90bffbc9.soyTemplateName = 'Templates.Boilerplate.__deltemplate_s66_90bffbc9';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Boilerplate.header'), '', 0, Templates.Boilerplate.__deltemplate_s66_90bffbc9);
